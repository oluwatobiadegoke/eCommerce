  ...
  return (
    <div className="flex justify-between h-32 bg-primary-100 px-2 py-2 shadow-lg">
      ...
      <div className="flex-1 h-full flex items-center justify-center gap-4">
        <AiOutlineMinus className="text-xl rounded p-1 hover:bg-primary-200 transition-all cursor-pointer" />
        <p className="font-primary">{amount}</p>
        <AiOutlinePlus className="text-xl rounded p-1 hover:bg-primary-200 transition-all cursor-pointer" />
      </div>
      <p className="flex-1 flex items-center justify-center font-bold font-primary">
        ${price}
      </p>
      <div className="flex items-center">
        <button className="rounded p-2 hover:bg-primary-200 transition-all cursor-pointer">
          <AiOutlineClose />
        </button>
      </div>
    </div>
